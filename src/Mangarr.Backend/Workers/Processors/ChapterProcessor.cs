...
//         {
//             _logger.LogError("Unable to get page list for {ChapterId} from {SourceId}: {Result}",
...
//         {
//             _logger.LogError("Unable to download pages for {ChapterId} from {SourceId}: {Result}",
//                 requestedChapterDocument.ChapterId,
//                 requestedMangaDocument.SourceId,
